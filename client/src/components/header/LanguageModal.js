...
const LanguageModal = ({ show, onHide }) => {
  ...
  const languageOptions = [
    ...
    { code: 'en', name: t('language.en', { lng: lang }), flag: '🇺🇸' },
    { code: 'es', name: t('language.es', { lng: lang }), flag: '🇪🇸' },
    { code: 'ru', name: t('language.ru', { lng: lang }), flag: '🇷🇺' },
    { code: 'kab', name: t('language.kab', { lng: lang }), flag: '🇩🇿' },
    { code: 'chino', name: t('language.chino', { lng: lang }), flag: '🇨🇳' }
  ];
